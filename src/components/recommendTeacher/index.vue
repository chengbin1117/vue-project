...
import ClassList from "@/components/common/RecommendList"
...
export default {
  ...
  data () {
    return {
        ...
        gradeList:[
            {name:'全部',id:'0',class:'parent font16 color333'},
            {name:'小学',id:'1',class:'parent font16 color333'},
            {name:'初中',id:'2',class:'parent font16 color333'}
        ],// 年级父分类
        gradeChild:[], // 年级子分类
        subjectList:[], // 学科类型
        otherList:[
  ...
  methods:{
    ...
    unfold(item,index){
        ...
        this.resetClass(this.gradeList,'font16 color333')
        ...
        this.gradeList.forEach(item =>{
            if(item.id == _this.gradeParentSelect){
                item.class = 'parent font16 color333 active'
            }
        })
