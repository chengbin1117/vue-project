    ...
    <div class="list f-r-sb" v-for="(item,index) in list" :key="index">
       <div class="f-r">
            <div class="check" v-if="editor">
                <i @click="handleChecked(item)" v-if="item.checked" class="iconfont icon-select colorbuy"></i>
                <i @click="handleChecked(item)" v-else class="iconfont icon-select color999"></i>
            </div>
            <div class="avatar">
